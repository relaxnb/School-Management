    ...
    <br />
      <div class="form-group row">
        ...
        <div class="col-md-3">
          ...
          <div class="col-md-9 col-sm-9">
          <select class="form-control" name="month_id" id="month_id" required="required">
          ...
          <span id="mnEmty" style="color: red;font-size: 15px;font-weight: bold;margin-left: 12px"></span>
        </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
      $(document).on('click','#search',function(){
        ...
        if(mn == 0){
          $("#mnEmty").html("Please select Month");
          return false;
        }
        $.ajax({
          url: "{{url('/get_stu_Month_info')}}",
          type: "GET",
          ...
          success:function(result){
            ...
            $.each(result.data,function(key,val){
              html +="<tr><td>"+(++key)+"</td><td>"+val.stu_id+"</td><td>"+val.stu_nm+"</td><td>"+val.roll+"</td><td>"+val.amount+"</td><td>"+val.discount+"%</td><td>"+(val.amount-(val.amount/100)*val.discount)+"</td><td><a href='{{url('download-monthSlip')}}/"+cls+"/"+yr+"/"+mn+"/"+val.roll+"'><button class='btn btn-sm btn-success'>Pay slip</button></a></td></tr>";
            });
