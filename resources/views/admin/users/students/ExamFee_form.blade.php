...
<div class="x_content">
    <br />
      <div class="form-group row">
        ...
        <div class="col-md-3">
          <label class="col-form-label col-md-3 col-sm-3 ">Exam</label>
          <div class="col-md-9 col-sm-9">
          ...
          <span id="exEmty" style="color: red;font-size: 15px;font-weight: bold;margin-left: 12px"></span>
        </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
      $(document).on('click','#search',function(){
        ...
        if(ex == 0){
          $("#exEmty").html("Please select Exam Name");
          return false;
        }
        $.ajax({
          url: "{{url('/get_stu_Exam_info')}}",
          type: "GET",
          ...
          success:function(result){
            ...
            $.each(result.data,function(key,val){
              html +="<tr><td>"+(++key)+"</td><td>"+val.stu_id+"</td><td>"+val.stu_nm+"</td><td>"+val.roll+"</td><td>"+val.amount+"</td><td>"+val.discount+"%</td><td>"+(val.amount-(val.amount/100)*val.discount)+"</td><td><a href='{{url('download-examSlip')}}/"+cls+"/"+yr+"/"+ex+"/"+val.roll+"'><button class='btn btn-sm btn-success'>Pay slip</button></a></td></tr>";
            });
