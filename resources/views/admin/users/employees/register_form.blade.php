...
@section('title','Employee Register Form')
...
<div class="x_content">
		<br />
		<form class="form-label-left input_mask" method="post" action="{{url('register_employee')}}" enctype="multipart/form-data">
			@csrf
			...
			<div class="form-group row">
				...
				<div class="col-md-4">
					<label class="col-form-label col-md-3 col-sm-3 ">Join Date</label>
					<div class="col-md-9 col-sm-9">
					<input type="date" class="form-control" name="join_date" required="required">
					</div>
				</div>
				<div class="col-md-4">
				...
				<div class="col-md-4">
					<label class="col-form-label col-md-3 col-sm-3 ">Salary</label>
					<div class="col-md-9 col-sm-9">
					<input type="text" name="salary" placeholder="Enter Salary amount" class="form-control">
					</div>
				</div>
			</div>
